...
System.register(['app/plugins/sdk', 'moment', 'lodash', 'jquery', 'jquery.flot', 'jquery.flot.gauge', 'app/core/utils/kbn', 'app/core/time_series2'], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export('DeltaPluginCtrl', DeltaPluginCtrl = function (_PanelCtrl) {
        _inherits(DeltaPluginCtrl, _PanelCtrl);
          ...
          value: function issueQueries(datasource) {
            ...
            return new Promise(function (resolve, reject) {
              ...
              return datasource.query(metricsQuery).then(function (res1) {
                ...
                _this3.panel.title = 'Delta ' + beginLastMonth.format('DD-MM hh-mm-ss a') + ' / ' + lastMonth.format('DD-MM hh-mm-ss a') + ' - ' + beginThisMonth.format('DD-MM hh-mm-ss a') + ' / ' + thisMonth.format('DD-MM hh-mm-ss a');
